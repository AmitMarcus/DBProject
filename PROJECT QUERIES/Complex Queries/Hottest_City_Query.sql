SELECT City.name AS City_Name,Event.id AS Event_ID,Event.name AS Event_Name,Category.name AS Category_Name,Event.description AS Event_Description,DATE(Event_Time.start_time) AS EventStartDate,DATE(Event_Time.end_time) as EventEndDate
