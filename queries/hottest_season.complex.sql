...
SELECT 
    ...
    Event_Guests.attending_count AS event_attending_count
FROM
    Event,
    Category,
    Place,
    ...
    FROM
        Event AS Event1, Place AS Place1, Event_Place AS EventPlace1, Street AS Street1, Event_Time AS EventTime1, Event_Guests AS EventGuests1, (SELECT 
        City.id
    FROM
        City
