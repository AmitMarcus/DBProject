...
def fetch_updated_event_guests_data(event_id):
    ...
    try:
        ...
        event = graph.get_objects(ids=[event_id],
                                           fields='id,maybe_count,noreply_count,interested_count')
    ...
    return event_interested_count, event_maybe_count, event_noreply_count


def execute_update_query(conn, event_id, event_interested_count, event_maybe_count, event_noreply_count):
    ...
    event_guests_parameters = (event_maybe_count,
...
def update_event_guests(conn, event_id):
    """ Fetches the updated event-guests interested / maybe / no-reply count using the facebook graph-api..
    ...
    """
    try:
        event_interested_count, event_maybe_count, event_noreply_count = fetch_updated_event_guests_data(event_id)
        ...
        execute_update_query(conn, event_id, event_interested_count, event_maybe_count, event_noreply_count)
...
if __name__ == '__main__':
    ...
    update_event_guests(con, '100101547171558')