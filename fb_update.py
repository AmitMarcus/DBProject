...
def execute_update_query(conn, event_id, event_attending_count, event_declined_count, event_interested_count,\
...
def update_event_guests(conn, event_id):
    ...
    try:
        ...
        execute_update_query(conn, event_id, event_attending_count, event_declined_count, event_interested_count,\
                             event_maybe_count, event_noreply_count)
